...
var ASM_CONSTS = {
  177196: ($0) => { ui_menu_clear($0); },  
 177219: ($0, $1, $2) => { ui_menu_add($0, $1, $2); },  
 177248: ($0, $1) => { ui_menu_select($0, $1); },  
 177276: ($0) => { ui_menu_clear($0); },  
 177299: ($0, $1, $2) => { ui_menu_add($0, $1, $2); },  
 177328: ($0, $1, $2) => { ui_menu_add($0, $1, $2); },  
 177357: ($0) => { ui_menu_clear($0); },  
 177380: ($0) => { ui_menu_clear($0); },  
 177403: ($0, $1, $2) => { ui_menu_add($0, $1, $2); },  
 177432: ($0, $1, $2) => { ui_menu_add($0, $1, $2); },  
 177461: ($0, $1, $2) => { ui_menu_add($0, $1, $2); },  
 177490: ($0, $1, $2) => { ui_menu_add($0, $1, $2); },  
 177519: ($0, $1) => { ui_menu_select($0, $1); },  
 177547: ($0, $1) => { ui_menu_select($0, $1); },  
 177575: ($0) => { ui_update_tape_input_filename($0); },  
 177614: ($0) => { ui_update_tape_playing($0); },  
 177646: ($0, $1, $2, $3, $4, $5) => { ui_update_disk_info($0, $1, $2, $3, $4, $5); },  
 177695: ($0) => { ui_update_disk_info($0, null, 0, 0, -1, 0); },  
 177743: ($0, $1) => { ui_set_html($0, $1); },  
 177768: ($0, $1) => { ui_update_hd_filename($0, $1); },  
 177803: ($0) => { ui_set_fullscreen($0); },  
 177830: ($0, $1) => { ui_menu_select($0, $1); },  
 177858: ($0, $1) => { ui_menu_select($0, $1); },  
 177886: ($0, $1) => { ui_menu_select($0, $1); },  
 177914: ($0, $1) => { ui_set_checkbox($0, $1); },  
 177943: ($0, $1) => { ui_menu_select($0, $1); },  
 177971: ($0, $1) => { ui_menu_select($0, $1); },  
 177999: ($0, $1) => { ui_set_checkbox($0, $1); },  
 178028: ($0, $1) => { ui_menu_select($0, $1); },  
 178056: ($0, $1) => { ui_set_checkbox($0, $1); },  
 178085: ($0, $1) => { ui_set_value($0, $1); },  
 178111: ($0, $1) => { ui_set_value($0, $1); },  
 178137: ($0, $1) => { ui_set_value($0, $1); },  
 178163: ($0, $1) => { ui_set_value($0, $1); },  
 178189: ($0, $1) => { ui_set_value($0, $1); },  
 178215: ($0, $1) => { ui_menu_select($0, $1); },  
 178243: ($0, $1) => { ui_menu_select($0, $1); },  
 178271: ($0) => { ui_menu_clear($0); },  
 178294: ($0, $1, $2) => { ui_menu_add($0, $1, $2); },  
 178323: () => { ui_done_initialising(); },  
 178347: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 178562: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 178709: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 178943: ($0) => { if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { if ((typeof navigator.userActivation) === 'undefined') { autoResumeAudioContext(SDL2.audioContext); } } } return SDL2.audioContext === undefined ? -1 : 0; },  
 179495: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
 179563: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearInterval(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; SDL2.capture.silenceBuffer = undefined } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vp', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vp', $2, [$3]); }; SDL2.capture.silenceTimer = setInterval(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); } },  
 181256: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } if (SDL2.audio.silenceTimer !== undefined) { clearInterval(SDL2.audio.silenceTimer); SDL2.audio.silenceTimer = undefined; SDL2.audio.silenceBuffer = undefined; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vp', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']); if (SDL2.audioContext.state === 'suspended') { SDL2.audio.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.audio.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { if ((typeof navigator.userActivation) !== 'undefined') { if (navigator.userActivation.hasBeenActive) { SDL2.audioContext.resume(); } } SDL2.audio.currentOutputBuffer = SDL2.audio.silenceBuffer; dynCall('vp', $2, [$3]); SDL2.audio.currentOutputBuffer = undefined; }; SDL2.audio.silenceTimer = setInterval(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); } },  
 182431: ($0, $1) => { var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } } },  
 183036: ($0, $1) => { var SDL2 = Module['SDL2']; var buf = $0 >>> 2; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[buf + (j*numChannels + c)]; } } },  
 183525: ($0) => { var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearInterval(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); } if (SDL2.audio.silenceTimer !== undefined) { clearInterval(SDL2.audio.silenceTimer); } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; } },  
 184531: ($0, $1, $2) => { var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Browser.createContext(Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); SDL2.data32Data = data; } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); },  
 185997: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 186985: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 187068: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 187137: () => { return window.innerWidth; },  
 187167: () => { return window.innerHeight; }
};

// Imports from the Wasm binary.
var _xroar_hard_reset,
  _xroar_soft_reset,
  _write_snapshot,
  _xroar_eject_disk,
  _xroar_eject_input_tape,
  _main,
  _wasm_set_int,
  _wasm_set_float,
  _wasm_set_joystick_port,
  _wasm_set_joystick_by_name,
  _wasm_gamepad_connected,
  _wasm_gamepad_disconnected,
  _wasm_set_machine_cart,
  _wasm_load_file,
  _wasm_queue_basic,
  _wasm_scan_press,
  _wasm_scan_release,
...
function assignWasmExports(wasmExports) {
  _xroar_hard_reset = Module['_xroar_hard_reset'] = wasmExports['xroar_hard_reset'];
  _xroar_soft_reset = Module['_xroar_soft_reset'] = wasmExports['xroar_soft_reset'];
  _write_snapshot = Module['_write_snapshot'] = wasmExports['write_snapshot'];
  _xroar_eject_disk = Module['_xroar_eject_disk'] = wasmExports['xroar_eject_disk'];
  _xroar_eject_input_tape = Module['_xroar_eject_input_tape'] = wasmExports['xroar_eject_input_tape'];
  _main = Module['_main'] = wasmExports['__main_argc_argv'];
  _wasm_set_int = Module['_wasm_set_int'] = wasmExports['wasm_set_int'];
  _wasm_set_float = Module['_wasm_set_float'] = wasmExports['wasm_set_float'];
  _wasm_set_joystick_port = Module['_wasm_set_joystick_port'] = wasmExports['wasm_set_joystick_port'];
  _wasm_set_joystick_by_name = Module['_wasm_set_joystick_by_name'] = wasmExports['wasm_set_joystick_by_name'];
  _wasm_gamepad_connected = Module['_wasm_gamepad_connected'] = wasmExports['wasm_gamepad_connected'];
  _wasm_gamepad_disconnected = Module['_wasm_gamepad_disconnected'] = wasmExports['wasm_gamepad_disconnected'];
  _wasm_set_machine_cart = Module['_wasm_set_machine_cart'] = wasmExports['wasm_set_machine_cart'];
  _wasm_load_file = Module['_wasm_load_file'] = wasmExports['wasm_load_file'];
  _wasm_queue_basic = Module['_wasm_queue_basic'] = wasmExports['wasm_queue_basic'];
  _wasm_scan_press = Module['_wasm_scan_press'] = wasmExports['wasm_scan_press'];
  _wasm_scan_release = Module['_wasm_scan_release'] = wasmExports['wasm_scan_release'];
  _wasm_resize = Module['_wasm_resize'] = wasmExports['wasm_resize'];
  _wasm_new_disk = Module['_wasm_new_disk'] = wasmExports['wasm_new_disk'];
  _wasm_vdrive_flush = Module['_wasm_vdrive_flush'] = wasmExports['wasm_vdrive_flush'];
  _wasm_read_byte = Module['_wasm_read_byte'] = wasmExports['wasm_read_byte'];
  _wasm_write_byte = Module['_wasm_write_byte'] = wasmExports['wasm_write_byte'];
  _wasm_get_pc = Module['_wasm_get_pc'] = wasmExports['wasm_get_pc'];
  _wasm_get_cc = Module['_wasm_get_cc'] = wasmExports['wasm_get_cc'];
  _wasm_get_a = Module['_wasm_get_a'] = wasmExports['wasm_get_a'];
  _wasm_get_b = Module['_wasm_get_b'] = wasmExports['wasm_get_b'];
  _wasm_get_x = Module['_wasm_get_x'] = wasmExports['wasm_get_x'];
  _wasm_get_y = Module['_wasm_get_y'] = wasmExports['wasm_get_y'];
  _wasm_get_s = Module['_wasm_get_s'] = wasmExports['wasm_get_s'];
  _wasm_js_set_axis = Module['_wasm_js_set_axis'] = wasmExports['wasm_js_set_axis'];
  _wasm_js_set_button = Module['_wasm_js_set_button'] = wasmExports['wasm_js_set_button'];
