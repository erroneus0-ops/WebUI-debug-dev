...
/** @type {function(string, boolean=, number=)} */
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(3, 0, 1, fd, addr, len, flags, u1, u2);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(4, 0, 1, fd, addr, len, u1, u2, u3);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(5, 0, 1, fd, addr, len, u1, u2, u3);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(11, 0, 1, fd, backlog, u1, u2, u3, u4);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(16, 0, 2, fds, nfds, timeout);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(17, 0, 1, fd, buf, len, flags, addr, alen);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(19, 0, 1, fd, buf, len, flags, addr, alen);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(20, 0, 1, fd, level, optname, optval, optlen, unused);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(21, 0, 1, domain, type, protocol, u1, u2, u3);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(36, 0, 1, dpy, surface);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(37, 0, 1, display, interval);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(38, 0, 1, display);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(40, 0, 1, nativeEngineId);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(45, 0, 1, status);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(82, 0, 1, fd, offset, whence, newOffset);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(83, 0, 1, fd, iov, iovcnt, pnum);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(84, 0, 1, node, service, hint, out);
