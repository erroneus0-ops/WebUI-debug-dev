...
Artifacting      EQU     0         ; Not using Artifact colours                              
        INCLUDE     ./BALL.asm
SpriteDrawTable:                              
        FDB     BALL_Draw     ; Points to the Sprite Drawing Table (in the compiled sprite.asm file)
        ...
        FDB     $0000         ; No sprite loaded in this slot
SpriteBackupTable:                              
        FDB     Backup_BALL   ; Address of the Make Backup code
        ...
        FDB     $0000         ; No Sprite for this slot
SpriteRestoreTable:                              
        FDB     Restore_BALL_0   ; Address of the restore code Buffer 0
        FDB     Restore_BALL_1   ; Address of the restore code Buffer 1
...
; '  BALLDEMO.BAS -- bouncing ball in SG12 (GMODE 7) 
; '  Sprite generated with:PNGtoCCSB-g7-s0BALL.png 
; DIM BX AS INTEGER ,BY AS INTEGER 
; DIM VX AS INTEGER ,VY AS INTEGER 
; SPRITE_LOAD "BALL.asm",0
; GMODE 7,1
...
; Starting if                      
        LDD     _Var_BX       ; Get the value of the variable
        PSHS    D             ; Save the value on the stack
        LDB     #47           ; B is an 8 bit integer from 0 to 255 (_Unsigned _Byte) ~%% format
        PSHS    B             ; Save B on the stack
; *** Doing CompareOp                      
...
_IFTrue_03                      
; BX =47
        LDD     #$002F        ; D is a 16 bit integer from -32768 to 32767 (signed Integer) % format
;        PSHS    D             ; Save D on the stack
;        PULS    D             ; Get value off the stack, fix the stack
        STD     _Var_BX       ; Save Numeric variable
; VX =-VX 
