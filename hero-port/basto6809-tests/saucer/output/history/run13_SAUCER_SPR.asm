; Sprite Name            : SAUCER_SPR
; Source PNG Width       : 20 
; Sprite Width in pixels : 40 
; Sprite Height in pixels: 32 
; # of Colours           :9
; # of Animation Frames  : 2 
; Required GMODE         : 7 
; Each PNG pixel occupies one complete two-subpixel semigraphics colour cell
SAUCER_SPR_Draw:
        FDB     SAUCER_SPR_0_0      ; Address to draw semigraphics sprite
        FDB     SAUCER_SPR_0_1      ; Address to draw semigraphics sprite
        FDB     SAUCER_SPR_1_0      ; Address to draw semigraphics sprite
        FDB     SAUCER_SPR_1_1      ; Address to draw semigraphics sprite
; Restore the background behind the sprite VSYNC 1
Restore_SAUCER_SPR_1:
...
; 028 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
; 029 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
; 030 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
; 031 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
...
Restore_SAUCER_SPR_0:
        PSHS    DP                  ; Save DP
        STS     @SaveSHere+2        ; Backup the stack pointer's value at the end of the backup routine (self mod)
        LDS     #SAUCER_SPR_BackupStart+32    ; Set S pointer to the end of the last row of the backup buffer + 32 extra space for stack during F/IRQ
        LEAU    1013,X              ; Point at the bottom, right edge of the sprite backup location
; Restoring row 31 
...
; Backup Sprite data for SAUCER_SPR
...
; Height is: 32 Rows
SAUCER_SPR_BackupStart:
        RMB     21*32+32            ; Reserve space for sprite background, plus a little extra for the stack (If F/IRQ happens)
SAUCER_SPR_BackupEnd:
Backup_SAUCER_SPR:
        PSHS    DP                  ; Save Condition Codes & DP
        STS     @SaveSHere+2        ; Backup the stack pointer's value at the end of the backup routine (self mod)
        LDS     #SAUCER_SPR_BackupEnd    ; Set S pointer to the end of the backup buffer
        LEAU    ,X                  ; U = X
; Backup row 0 
...
; Frame Number: 1  pixel shift: 0 
SAUCER_SPR_1_0:
        LDA     #$9F                ; Semigraphics cell
        STA     8,X                 ; Draw two-pixel cell
        LDA     #$9F                ; Semigraphics cell
        STA     9,X                 ; Draw two-pixel cell
        LDA     #$9F                ; Semigraphics cell
...
; Frame Number: 1  pixel shift: 1 
SAUCER_SPR_1_1:
        LDA     #$95                ; Semigraphics cell
        STA     8,X                 ; Draw two-pixel cell
        LDA     #$9F                ; Semigraphics cell
        STA     9,X                 ; Draw two-pixel cell
        LDA     #$9F                ; Semigraphics cell
