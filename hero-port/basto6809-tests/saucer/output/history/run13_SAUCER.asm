...
; '   
; '  Proportions updated 2026-09-05:discisnow~2xthedome'swidth 
...
; '  every colour added. 
; '   
; '  The LOADM ceiling itself , for reference:6framesofthe*original* 
; '  (narrower) art (23569 bytes) reliably fails with PRINT IO ERROR ; 5 frames 
