...
Artifacting      EQU     0         ; Not using Artifact colours                              
        INCLUDE     ./SAUCER_SPR.asm
SpriteDrawTable:                              
        FDB     SAUCER_SPR_Draw   ; Points to the Sprite Drawing Table (in the compiled sprite.asm file)
        ...
        FDB     $0000         ; No sprite loaded in this slot
SpriteBackupTable:                              
        FDB     Backup_SAUCER_SPR   ; Address of the Make Backup code
        ...
        FDB     $0000         ; No Sprite for this slot
SpriteRestoreTable:                              
        FDB     Restore_SAUCER_SPR_0   ; Address of the restore code Buffer 0
        FDB     Restore_SAUCER_SPR_1   ; Address of the restore code Buffer 1
...
; '   
; '  Proportions (2026-09-05 , second pass):discwidenedto~2xthe 
...
; '   
; '  Space-bar exit:addedperrequest,usingthedocumentedINKEY$ 
...
;        PULS    D             ; Get value off the stack, fix the stack
        STD     _Var_BX       ; Save Numeric variable
; BY =0
        LDD     #$0000        ; D is a 16 bit integer from -32768 to 32767 (signed Integer) % format
;        PSHS    D             ; Save D on the stack
;        PULS    D             ; Get value off the stack, fix the stack
...
;        PSHS    D             ; Save D on the stack
;        PULS    D             ; Get value off the stack, fix the stack
        STD     _Var_VX       ; Save Numeric variable
; VY =1
        LDD     #$0001        ; D is a 16 bit integer from -32768 to 32767 (signed Integer) % format
;        PSHS    D             ; Save D on the stack
;        PULS    D             ; Get value off the stack, fix the stack
...
;        PSHS    D             ; Save D on the stack
;        PULS    D             ; Get value off the stack, fix the stack
        STD     _Var_FRAME    ; Save Numeric variable
_LMainLoop
...
;        PULS    B             ; Get value in B and Fix the stack
        ...
        LDD     _Var_BX       ; Get the value of the variable
...
;        PULS    B             ; Get value in B and Fix the stack
        PSHS    B             ; Save the Sprite #
        LDD     _Var_FRAME    ; Get the value of the variable
;        PSHS    D             ; Save the value on the stack
;        PULS    D             ; Get value in B and Fix the stack
...
@Done:                        
        ...
        FCB     $20           ;  
        FCB     $01           ; Length of the string
@CopyToStack                      
        LDB     #$02          ; Length of the string
        PULS    U             
!       LDA     ,U+           
        STA     ,-S           
        DECB                  
...
; BX =BX +VX 
        LDD     _Var_BX       ; Get the value of the variable
        PSHS    D             ; Save the value on the stack
        LDD     _Var_VX       ; Get the value of the variable
;        PSHS    D             ; Save the value on the stack
; Doing ADD:                      
...
; Starting if                      
        LDD     _Var_BX       ; Get the value of the variable
        PSHS    D             ; Save the value on the stack
        LDB     #23           ; B is an 8 bit integer from 0 to 255 (_Unsigned _Byte) ~%% format
        PSHS    B             ; Save B on the stack
; *** Doing CompareOp                      
...
_IFTrue_03                      
; BX =23
        LDD     #$0017        ; D is a 16 bit integer from -32768 to 32767 (signed Integer) % format
;        PSHS    D             ; Save D on the stack
;        PULS    D             ; Get value off the stack, fix the stack
        STD     _Var_BX       ; Save Numeric variable
; VX =-VX 
